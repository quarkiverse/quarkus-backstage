...
public class GroupSpecFluent<A extends GroupSpecFluent<A>> extends BaseFluent<A>{
  ...
  public A withProfile(Profile profile) {
    ...
    if (profile!=null){ this.profile= new ProfileBuilder(profile); _visitables.get("profile").add(this.profile);} else { this.profile = null; _visitables.get("profile").remove(this.profile); } return (A) this;
  }
  ...
  public A addToChildren(int index,String item) {
    if (this.children == null) {this.children = new ArrayList<String>();}
  ...
  public A setToChildren(int index,String item) {
    if (this.children == null) {this.children = new ArrayList<String>();}
    this.children.set(index, item); return (A)this;
  }
  
  public A addToChildren(java.lang.String... items) {
    if (this.children == null) {this.children = new ArrayList<String>();}
    for (String item : items) {this.children.add(item);} return (A)this;
  }
  ...
  public A removeFromChildren(java.lang.String... items) {
    if (this.children == null) return (A)this;
    for (String item : items) { this.children.remove(item);} return (A)this;
  }
  ...
  public String getMatchingChild(Predicate<String> predicate) {
    for (String item: children) { if(predicate.test(item)){ return item;} } return null;
  }
  
  public boolean hasMatchingChild(Predicate<String> predicate) {
    for (String item: children) { if(predicate.test(item)){ return true;} } return false;
  }
  
  public A withChildren(List<String> children) {
    if (children != null) {this.children = new ArrayList(); for (String item : children){this.addToChildren(item);}} else { this.children = null;} return (A) this;
  }
  
  public A withChildren(java.lang.String... children) {
    if (this.children != null) {this.children.clear(); _visitables.remove("children"); }
    if (children != null) {for (String item :children){ this.addToChildren(item);}} return (A) this;
  }
  ...
  public A setToMembers(int index,String item) {
    if (this.members == null) {this.members = new ArrayList<String>();}
    this.members.set(index, item); return (A)this;
  }
  
  public A addToMembers(java.lang.String... items) {
    if (this.members == null) {this.members = new ArrayList<String>();}
    for (String item : items) {this.members.add(item);} return (A)this;
  }
  ...
  public A removeFromMembers(java.lang.String... items) {
    if (this.members == null) return (A)this;
    for (String item : items) { this.members.remove(item);} return (A)this;
  }
  ...
  public String getMatchingMember(Predicate<String> predicate) {
    for (String item: members) { if(predicate.test(item)){ return item;} } return null;
  }
  
  public boolean hasMatchingMember(Predicate<String> predicate) {
    for (String item: members) { if(predicate.test(item)){ return true;} } return false;
  }
  
  public A withMembers(List<String> members) {
    if (members != null) {this.members = new ArrayList(); for (String item : members){this.addToMembers(item);}} else { this.members = null;} return (A) this;
  }
  
  public A withMembers(java.lang.String... members) {
    if (this.members != null) {this.members.clear(); _visitables.remove("members"); }
    if (members != null) {for (String item :members){ this.addToMembers(item);}} return (A) this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!java.util.Objects.equals(children, that.children)) return false;
  
    if (!java.util.Objects.equals(members, that.members)) return false;
  ...
  public String toString() {
    ...
    if (children != null && !children.isEmpty()) { sb.append("children:"); sb.append(children + ","); }
    if (members != null && !members.isEmpty()) { sb.append("members:"); sb.append(members + ","); }
