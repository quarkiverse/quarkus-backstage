...
public class UserSpecFluent<A extends UserSpecFluent<A>> extends BaseFluent<A>{
  ...
  public A addToMemberOf(int index,String item) {
    if (this.memberOf == null) {this.memberOf = new ArrayList<String>();}
  ...
  public A setToMemberOf(int index,String item) {
    if (this.memberOf == null) {this.memberOf = new ArrayList<String>();}
    this.memberOf.set(index, item); return (A)this;
  }
  
  public A addToMemberOf(java.lang.String... items) {
    if (this.memberOf == null) {this.memberOf = new ArrayList<String>();}
    for (String item : items) {this.memberOf.add(item);} return (A)this;
  }
  ...
  public A removeFromMemberOf(java.lang.String... items) {
    if (this.memberOf == null) return (A)this;
    for (String item : items) { this.memberOf.remove(item);} return (A)this;
  }
  ...
  public String getMatchingMemberOf(Predicate<String> predicate) {
    for (String item: memberOf) { if(predicate.test(item)){ return item;} } return null;
  }
  
  public boolean hasMatchingMemberOf(Predicate<String> predicate) {
    for (String item: memberOf) { if(predicate.test(item)){ return true;} } return false;
  }
  
  public A withMemberOf(List<String> memberOf) {
    if (memberOf != null) {this.memberOf = new ArrayList(); for (String item : memberOf){this.addToMemberOf(item);}} else { this.memberOf = null;} return (A) this;
  }
  
  public A withMemberOf(java.lang.String... memberOf) {
    if (this.memberOf != null) {this.memberOf.clear(); _visitables.remove("memberOf"); }
    if (memberOf != null) {for (String item :memberOf){ this.addToMemberOf(item);}} return (A) this;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!java.util.Objects.equals(memberOf, that.memberOf)) return false;
  ...
  public String toString() {
    ...
    if (memberOf != null && !memberOf.isEmpty()) { sb.append("memberOf:"); sb.append(memberOf + ","); }
