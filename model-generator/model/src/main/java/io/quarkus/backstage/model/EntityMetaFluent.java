...
public class EntityMetaFluent<A extends EntityMetaFluent<A>> extends BaseFluent<A> {
    ...
    public A addToLinks(io.quarkus.backstage.model.EntityLink... items) {
        if (this.links == null) {
            this.links = new ArrayList<EntityLinkBuilder>();
        }
    ...
    public A removeFromLinks(io.quarkus.backstage.model.EntityLink... items) {
        if (this.links == null)
            return (A) this;
        for (EntityLink item : items) {
            EntityLinkBuilder builder = new EntityLinkBuilder(item);
    ...
    public A withLinks(io.quarkus.backstage.model.EntityLink... links) {
        if (this.links != null) {
            this.links.clear();
