...
public interface Visitable<T> {
    ...
    default T accept(io.quarkus.backstage.model.builder.Visitor... visitors) {
    ...
    default T accept(List<Entry<String, Object>> path, io.quarkus.backstage.model.builder.Visitor... visitors) {
