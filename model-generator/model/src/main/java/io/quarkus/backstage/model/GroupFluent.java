...
public class GroupFluent<A extends GroupFluent<A>> extends BaseFluent<A>{
  ...
  public A withSpec(GroupSpec spec) {
    ...
    if (spec!=null){ this.spec= new GroupSpecBuilder(spec); _visitables.get("spec").add(this.spec);} else { this.spec = null; _visitables.get("spec").remove(this.spec); } return (A) this;
  }
