...
public class ResourceFluent<A extends ResourceFluent<A>> extends BaseFluent<A>{
  ...
  public A withSpec(ResourceSpec spec) {
    ...
    if (spec!=null){ this.spec= new ResourceSpecBuilder(spec); _visitables.get("spec").add(this.spec);} else { this.spec = null; _visitables.get("spec").remove(this.spec); } return (A) this;
  }
