...
public class BaseFluent<F extends Fluent<F>> implements Fluent<F>, Visitable<F> {
    ...
    public static <T> List<T> build(List<? extends io.quarkiverse.backstage.model.builder.Builder<? extends T>> list) {
        return list == null ? null : list.stream().map(Builder::build).collect(Collectors.toList());
    }

    public static <T> Set<T> build(Set<? extends io.quarkiverse.backstage.model.builder.Builder<? extends T>> set) {
    ...
    public F accept(io.quarkiverse.backstage.model.builder.Visitor... visitors) {
    ...
    public F accept(List<Entry<String, Object>> path, io.quarkiverse.backstage.model.builder.Visitor... visitors) {
