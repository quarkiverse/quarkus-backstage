...
public class ComponentFluent<A extends ComponentFluent<A>> extends BaseFluent<A> {
    ...
    protected void copyInstance(Component instance) {
        instance = (instance != null ? instance : new Component());
    ...
    public class MetadataNested<N> extends EntityMetaFluent<MetadataNested<N>> implements Nested<N> {
        ...
        public N and() {
            return (N) ComponentFluent.this.withMetadata(builder.build());
        }
    ...
    public class StatusNested<N> extends StatusFluent<StatusNested<N>> implements Nested<N> {
        ...
        public N and() {
            return (N) ComponentFluent.this.withStatus(builder.build());
        }
