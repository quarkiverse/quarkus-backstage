...
public class TemplateSpecFluent<A extends TemplateSpecFluent<A>> extends BaseFluent<A> {
    ...
    public A addToParameters(io.quarkiverse.backstage.scaffolder.v1beta3.Parameter... items) {
        if (this.parameters == null) {
            this.parameters = new ArrayList<ParameterBuilder>();
        }
    ...
    public A removeFromParameters(io.quarkiverse.backstage.scaffolder.v1beta3.Parameter... items) {
        if (this.parameters == null)
            return (A) this;
        for (Parameter item : items) {
            ParameterBuilder builder = new ParameterBuilder(item);
    ...
    public A withParameters(io.quarkiverse.backstage.scaffolder.v1beta3.Parameter... parameters) {
        if (this.parameters != null) {
    ...
    public A addToSteps(io.quarkiverse.backstage.scaffolder.v1beta3.Step... items) {
        if (this.steps == null) {
            this.steps = new ArrayList<StepBuilder>();
        }
        for (Step item : items) {
    ...
    public A removeFromSteps(io.quarkiverse.backstage.scaffolder.v1beta3.Step... items) {
        if (this.steps == null)
            return (A) this;
        for (Step item : items) {
            StepBuilder builder = new StepBuilder(item);
    ...
    public A withSteps(io.quarkiverse.backstage.scaffolder.v1beta3.Step... steps) {
        if (this.steps != null) {
            this.steps.clear();
