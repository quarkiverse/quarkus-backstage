...
public class StatusFluent<A extends StatusFluent<A>> extends BaseFluent<A> {
    ...
    public A addToItems(io.quarkiverse.backstage.v1alpha1.StatusItem... items) {
        if (this.items == null) {
            this.items = new ArrayList<StatusItemBuilder>();
        }
    ...
    public A removeFromItems(io.quarkiverse.backstage.v1alpha1.StatusItem... items) {
        if (this.items == null)
            return (A) this;
        for (StatusItem item : items) {
            StatusItemBuilder builder = new StatusItemBuilder(item);
    ...
    public A withItems(io.quarkiverse.backstage.v1alpha1.StatusItem... items) {
        if (this.items != null) {
            this.items.clear();
