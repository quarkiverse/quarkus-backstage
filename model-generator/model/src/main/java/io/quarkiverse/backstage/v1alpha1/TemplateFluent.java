...
public class TemplateFluent<A extends TemplateFluent<A>> extends BaseFluent<A> {
    ...
    private TemplateSpecBuilder spec;
    ...
    public TemplateSpec buildSpec() {
        return this.spec != null ? this.spec.build() : null;
    }

    public A withSpec(TemplateSpec spec) {
        _visitables.get("spec").remove(this.spec);
        if (spec != null) {
            this.spec = new TemplateSpecBuilder(spec);
    ...
    public SpecNested<A> withNewSpecLike(TemplateSpec item) {
    ...
    public SpecNested<A> editOrNewSpec() {
        return withNewSpecLike(java.util.Optional.ofNullable(buildSpec()).orElse(new TemplateSpecBuilder().build()));
    }

    public SpecNested<A> editOrNewSpecLike(TemplateSpec item) {
    ...
    public class SpecNested<N> extends TemplateSpecFluent<SpecNested<N>> implements Nested<N> {
        SpecNested(TemplateSpec item) {
            this.builder = new TemplateSpecBuilder(this, item);
        }

        TemplateSpecBuilder builder;
    ...
    public class StatusNested<N> extends StatusFluent<StatusNested<N>> implements Nested<N> {
        ...
        public N and() {
            return (N) TemplateFluent.this.withStatus(builder.build());
        }
